...
internal class Program
{
    public static void Main(string[] args)
    {
        ...
        //
        // Console.WriteLine($"Átlagos életkor: {avgAge}");
        //
        ...
        // }
        //
        // Console.WriteLine($"A legidősebb tapasztalt programozó neve: {names[idx]}, életkor: {max}");
        ...
        Console.WriteLine(
            $"A legtöbb halat a(z) {maxIdx + 1}. versenyző fogta, összesen: {max}db."
        );
